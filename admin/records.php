                  ...
                  <div class="row mb-2">
                     ...
                     <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                           ...
                           '; 
                           $sql = "SELECT tbl_member.first_name, tbl_member.last_name, tbl_garbage_type.name, tbl_collection_record.quantity, tbl_collection_record.unit, tbl_collection_record.total_amount, tbl_collection_record.date FROM tbl_member
                           JOIN tbl_collection_record ON tbl_collection_record.member_id = tbl_member.member_id
                           JOIN tbl_garbage_type ON tbl_garbage_type.type_id = tbl_collection_record.type_id";
